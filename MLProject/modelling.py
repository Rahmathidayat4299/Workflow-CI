...
train_df = pd.read_csv("../MLProject/Graduate_indicators_preprocessing/train_processed.csv")
test_df = pd.read_csv("../MLProject/Graduate_indicators_preprocessing/test_processed.csv")
